...
export default function Header({ shop_name, instagram_id }: shopInfoType) {
  ...
  const [isEditVisible, setEditVisible] = useState(false); // 編集モードの表示状態
    ...
    <div className="bg-[#FDFF89] p-3">
      <div className="relative mx-auto flex max-w-[355px] items-center justify-between">
        ...
        <div className="flex items-center">
          <h1 className="font-semibold tracking-wider">{shop_name}</h1>
          {instagram_id && (
        ...
        <button
          className="pointer-cursor h-5 w-5"
        ...
        >
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle cx="1.5" cy="1.5" r="1.5" fill="#090A0A" />
            <circle cx="7.5" cy="1.5" r="1.5" fill="#090A0A" />
